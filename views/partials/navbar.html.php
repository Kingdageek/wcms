        <header>
          <nav class="navbar navbar-expand-lg navbar-light bg-dark">
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  ...
                  <a class="nav-item nav-link sl" href="<?=URLROOT;?>/save_newcomer">Save Newcomers Details</a>
                  <a class="nav-item nav-link sl" href="<?=URLROOT;?>/send_sms">Send SMS</a>
                  <a class="nav-item nav-link sl" href="<?=URLROOT;?>/send_sms_to_select">Send SMS To Selected</a>
                  <a class="nav-item nav-link sl" href="<?=URLROOT;?>/add_admin">Add New Admin</a>
                  <a class="nav-item nav-link sl" href="<?=URLROOT;?>/logout">Logout (<?= $username;?>)</a>
              </div>
          </nav>
      </header>